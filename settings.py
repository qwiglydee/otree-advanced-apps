...
SESSION_CONFIGS = [
    ...
    dict(
        name="lottery1_full",
        display_name="lottery1 (full disclosure)",
    ...
    dict(
        name="lottery1_chice",
        display_name="lottery1 (choice disclosure)",
        app_sequence=["lottery1"],
        condition="random",
        disclosure="CHOICE",
    ),
    dict(
        name="lottery2s_full",
        display_name="lottery2s (full disclosure)",
        app_sequence=["lottery2s"],
        condition="random",
        disclosure="FULL",
    ),
    dict(
        name="lottery2s_choice",
        display_name="lottery2s (choice disclosure)",
        app_sequence=["lottery2s"],
        condition="random",
        disclosure="CHOICE",
    ),
