...
class LiveMethods:
    ...
    def live_response(page, player: Player, message: dict):
        ...
        response = progress.respond(current, message['stage'], response_time=message['time'], button=button, choice=choice)
...
class Tasks(LiveMethods, Page):
    ...
    def display_progress(current: Progress):
        ...
        return {
            ...
            "finalizable": progress.trial_finalizable(current.trial) if current.trial else None,
        }
